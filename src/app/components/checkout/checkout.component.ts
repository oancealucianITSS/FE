...
import { ChestiifaineValidators } from 'src/app/validators/chestiifaine-validators';
...
export class CheckoutComponent implements OnInit {
      ...
      customer: this.formBuilder.group({
        firstName: new FormControl('',
                               [Validators.required, 
                                ...
                                ChestiifaineValidators.notOnlyWhiteSpace]),
  ...
  reviewCartDetails() {
    //subscribe to cartservice.totalQautity
